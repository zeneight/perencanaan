<?php namespace App\Http\Controllers;
	...
	class AdminTbIkBarang13Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Kegiatan (sesuai DIPA)','name'=>'kegiatan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Apakah barang ini Terdapat di e-Katalog LKPP','name'=>'ada_ekatalog','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Ya;Tidak'];
			$this->form[] = ['label'=>'Jelaskan Tingkat prioritas kebutuhan Barang. Bila perlu mohon dijelaskan pada pilihan lainnya','name'=>'tingkat_prioritas_brg','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Tinggi;Sedang;Rendah'];
			...
			$this->form[] = ['label'=>'Apakah PPK dibantu oleh Tim atau Tenaga Ahli. Jelaskan pada kotak "Lainnya"','name'=>'ada_team_ahli','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Ya;Tidak'];
			$this->form[] = ['label'=>'Tingkat beban tugas dan tanggung jawab pegawai dalam melaksanakan tugas dan fungsi Tim Pengelolaan Manajemen PPK','name'=>'tingkat_beban_tugas','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Tinggi;Sedang;Rendah'];
			...
			$this->form[] = ['label'=>'Apabila jumlah barang saat ini belum memenuhi kebutuhan, Jelaskan kebutuhan barang','name'=>'kebutuhan_barang','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Ya;Tidak'];
			...
			$this->form[] = ['label'=>'Kemudahan memperoleh Barang di pasaran Indonesia sesuai dengan jumlah yang dibutuhkan','name'=>'kemudahan_peroleh_barang','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Ya;Tidak'];
			$this->form[] = ['label'=>'Terdapat produsen/pelaku usaha yang dinilai mampu dan memenuhi syarat','name'=>'terdapat_produsen','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Banyak;Terbatas'];
